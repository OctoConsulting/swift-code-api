...
/**
 * <p>Java class for ExclusionAddressType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExclusionAddressType">
 *   &lt;complexContent>
...
@XmlType(name = "ExclusionAddressType", propOrder = {
    "street1",
    "street2",
    "city",
    "state",
...
public class ExclusionAddressType
    extends ExclusionValueObjectType
{
    ...
    @XmlElementRef(name = "province", type = JAXBElement.class, required = false)
    protected JAXBElement<String> province;
    @XmlElementRef(name = "zipOrPostalcode", type = JAXBElement.class, required = false)
