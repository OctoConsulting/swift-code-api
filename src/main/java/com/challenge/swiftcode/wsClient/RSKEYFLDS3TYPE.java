...
/**
 * <p>Java class for RS_KEY_FLDS3_TYPE complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RS_KEY_FLDS3_TYPE">
 *   &lt;complexContent>
 ...
 *                     &lt;element name="UPD" type="{http://www.w3.org/2001/XMLSchema}string" form="qualified"/>
 *                   &lt;/choice>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
...
@XmlType(name = "RS_KEY_FLDS3_TYPE", propOrder = {
    "keyfld"
})
public class RSKEYFLDS3TYPE {

    @XmlElement(name = "KEY_FLD", namespace = "http://www.sam.gov")
    protected List<RSKEYFLDS3TYPE.KEYFLD> keyfld;
     ...
     * {@link RSKEYFLDS3TYPE.KEYFLD }
     * 
     * 
     */
    public List<RSKEYFLDS3TYPE.KEYFLD> getKEYFLD() {
        if (keyfld == null) {
            keyfld = new ArrayList<RSKEYFLDS3TYPE.KEYFLD>();
        }
        return this.keyfld;
    }
    ...
    public static class KEYFLD {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "UPD", namespace = "http://www.sam.gov", type = JAXBElement.class, required = false),
